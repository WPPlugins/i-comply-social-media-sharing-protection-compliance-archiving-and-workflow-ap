...
<div id="main">
		<div align="center">
			<img
				src="<?php echo plugins_url( 'icomply', 'icomply' ).'/icomply.png';?>"
				height="50" />
		</div>
		<span id="icomplyLogo"></span>
		<div id="icomplyWelcome" align="center">
			<b>Welcome to i-Comply !</b>
		</div>
		<div class="menu" style="padding-bottom: 5%; text-align: center;">Thank
			you for downloading the i-Comply Wordpress plugin. Please select from
		...
		<div id="settingDiv" align="center" style="display: block;">
			<TABLE CELLPADDING="15" align="center">
				<tbody>
					<TR bgcolor="#EBFAFF">
						<TD>I already have an i-Comply account. activate my plugin now.</TD>
					...
					<TR bgcolor="#EBFAFF">
						<TD>Setup my wordpress in i-Comply now.</TD>
						<TD ALIGN="CENTER"><a href="http://icomply02.isocialsmart.com/icomply-web/wordpress" target="_blank"><input id="signUpForiComplyButton" type="button" value="Setup wordpress in i-Comply" class="button button-primary" /></a>
						</TD>
					</TR>
					<TR bgcolor="#EBFAFF">
						<TD>I do not currently have an i-Comply account. Sign up for
							i-Comply now.</TD>
						<TD ALIGN="CENTER"><a href="http://isocialsmart.com/trial-2/" target="_blank"><input id="signUpForiComplyButton" type="button" value="Sign up for i-Comply" class="button button-primary" /></a>
						</TD>
					</TR>					
					<TR bgcolor="#EBFAFF">
						<TD>I need more information about i-Comply before I Sign up</TD>
			...
			<TABLE CELLPADDING="5" align="center"
				...
				<tbody>
					...
					<TR align="left" bgcolor="#EBFAFF">
						...
						<TD align="right"><a href="#" id="resetButtonL"><a href="http://icomply02.isocialsmart.com/icomply-web/wordpress" style="font-weight:normal;font-size:12px;" target="_blank">Setup Wordpress in i-Comply</a></TD>
					</TR>
				</tbody>
			</TABLE>
		</div>
		<div id="detailsDiv" style="display: none;" align="center">
			<TABLE CELLPADDING="0" align="center" 
	    		...
	    		<tr>
	                <td>
	                    <table width="100%" cellpadding="0" cellspacing="0">
	                             <tr align="left"><td valign="middle" width="45%"><b>Custom Message</b><td><img  src="<?php echo plugins_url( 'icomply', 'icomply' ).'/blue_question_mark.jpg'; ?>" title="{POST_TITLE}=>Title of post&#013;{PERMALINK}=>Permalink to your post"  onclick="alert(' {POST_TITLE}=>Title of post \n {PERMALINK}=>Permalink to your post');"  /></td> </tr>
    		...
    		<TR align="center" bgcolor="#fff">
						<TD colspan="2"><input type="button"
							value="Post To i-Comply" class="button button-primary"
			...
			<TABLE CELLPADDING="3" align="center" bgcolor="#fff"
				...
				<tbody>
					<TR>
						<TD align="center"><h2>How i-Comply Plugin works</h2></TD>
					</TR>
					<TR>
						<TD align="center"><p>This guide provides instructions for how to connect your WordPress blog to i-Comply social networking services. Once connected to a service, all of your WordPress posts will be shared with that service automatically.</p></TD>
					</TR>
					<TR>
					...
					<TR>
    					...
    					<TR >
    						<TD align="left"><h4>1) Using i-Comply</h4>
    						<p>Once you activated i-Comply plugin, you'll see an i-Comply section in the Publish box on your post writing screen each time you write a new post.<br><img src="<?php echo plugins_url( 'icomply', 'icomply' ).'/screens/settings1.png';?>" width="240" /> <img src="<?php echo plugins_url( 'icomply', 'icomply' ).'/screens/settings2.png';?>"  width="240" /></p>
    						<p>When you publish your post as usual, you'll see it show up on the services you've enabled. If you want to opt out from any of the services for a specific post, click the <a>"Edit"</a> link next to the i-Comply as shown above.
    					...
    					<TR >
    						<TD align="left"><img src="<?php echo plugins_url( 'icomply', 'icomply' ).'/screens/published.png';?>"  width="500" /></TD>
    					</TR>
    					<TR >
    						<TD align="left"><h4>2) i-Comply Settings</h4>
    						<p>To set up i-Comply on your WordPress site, please go to Settings -> i-Comply Settings in your site Dashboard.</p>
    						<img src="<?php echo plugins_url( 'icomply', 'icomply' ).'/screens/settings.png';?>" /></TD>
    					</TR>
    					<TR >
    						<TD align="left"><h4>3) Wordpress Settings in i-Comply </h4>
    						<p>To publish our post using i-comply,we need to enter authentication details of Wordpress in i-Comply site. To Setup Wordpress in i-Comply, click on <a href="http://icomply02.isocialsmart.com/icomply-web/wordpress" target="_blank">this link </a></p>
    						<img src="<?php echo plugins_url( 'icomply', 'icomply' ).'/screens/setup.png';?>" width="500" /></TD>
    					</TR>
						</TABLE>			
				</tbody>
			</TABLE>
		...
		jQuery.ajax({
			...
			success: function (response) {
  				if(response === "done") {
	                ...
	                jQuery('#icomplymessage').html('i-Comply '+posttype+' - Success!!');
	            	...
	            	jQuery('#icomplymessage').css('color','red');
	            	jQuery('#icomplymessage').html('i-Comply '+posttype+' - Failed!!');
	            }
	        }
		});  			  	  		
	}
